...
INSERT INTO ingredients (id, ingredient, recipe_id, amount, unit_id)
VALUES
(1, 'whole chicken wings', 1, 1),
(2, 'siracha', 1, 1),
(3, 'honey', 1, 1),
(4, 'salt', 1, 1),
(5, 'black sesame seed', 1, 1),
(6, 'coarse black pepper', 1, 1),
(7, 'butter', 1, 1),
(8, 'bacon', 2, 1),
(9, 'chorizo', 2, 1),
(10, 'jalapenos', 2, 1),
(11, 'cream cheese', 2),
(12, 'shredded cheddar', 2),
(13, 'BBQ rub', 2),
(14, 'bratwurst', 3),
(15, 'buns', 3),
(16,'Beer', 3),
...
(30, 'dill', 4),
(31, 'olive oil', 4),
(32, 'whole artichoke', 5),
(33, 'garlic', 5),
(34, 'pistachios', 5),
(35, 'greek yogurt', 5),
(36, 'corriander', 5),
(37, 'white sesame seed', 5);
